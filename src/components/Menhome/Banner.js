...
import Slideone from '../../assets/images/main-slider/patty-melt-slider-2.jpg'
                                        ...
                                        <div className="content-box">
                                            <div className="content">
                                                <div className="clearfix">
                                                    <div className="inner">
                                                        <div className="subtitle"><span>Your Neighborhood Bar</span></div>
                                                        ...
                                                        <h1><span>The Fainting Goat</span></h1>
                                                        <h2>Denver's #1 Irish Pub</h2>
                                                        <div className="text">It is a great place to grab a bite and beers for lunch or meet some friends for drinks anytime. <br /> We are dog friendly. So bring your buddy.<br /> WIFI is available if you need to get some work done.</div>
